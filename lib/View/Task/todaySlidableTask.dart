...
class TodaySlidableTask extends StatefulWidget {
  final Liste list;

  const TodaySlidableTask({Key? key, required this.list}) : super(key: key);

  @override
  State<TodaySlidableTask> createState() => _TodaySlidableTaskState();
}

class _TodaySlidableTaskState extends State<TodaySlidableTask>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<Task>>(
      stream: NoSqlTask().getAllForToday(widget.list),
