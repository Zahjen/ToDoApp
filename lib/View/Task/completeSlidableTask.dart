...
class CompleteSlidableTask extends StatefulWidget {
  final Liste list;

  const CompleteSlidableTask({Key? key, required this.list}) : super(key: key);

  @override
  State<CompleteSlidableTask> createState() => _CompleteSlidableTaskState();
}

class _CompleteSlidableTaskState extends State<CompleteSlidableTask>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<Task>>(
        stream: NoSqlTask().getAllTrue(widget.list),
